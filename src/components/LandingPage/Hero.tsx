...
const Hero = () => {
  return (
    ...
    >
        ...
        <button className="flex h-12 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full bg-gold px-6 text-base font-bold leading-normal text-white transition-opacity hover:opacity-90">
